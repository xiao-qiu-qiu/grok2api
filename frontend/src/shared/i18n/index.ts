  ...
  "zh-CN": {
    translation: {
      ...
      webAccountSettings: {
        ...
        excludeFromTraining: "关闭训练数据使用",
        excludeFromTrainingTitle: "关闭“允许使用训练数据”？",
        excludeFromTrainingDescription: "关闭 Grok 的 Improve the Model 设置，阻止此账号的内容用于模型改进。",
        excludeFromTrainingDone: "训练数据使用已关闭",
      },
      webAccountScripts: {
        action: "账号工具",
        allTitle: "账号工具",
        ...
        excludeFromTrainingDescription: "关闭 Grok 的 Improve the Model 设置，阻止这些账号的内容用于模型改进。",
        run: "执行任务",
      ...
      statusReauthRequired: "失效",
        ...
        trainingDataExcludedMark: "训练数据已关闭",
        trainingDataExcludedTooltip: "已关闭训练数据使用 · {{time}}",
        riskFilter: "风控",
        riskNormal: "正常",
      ...
      audits: {
        ...
        firstTokenMetric: "首字",
        throughputMetric: "速度",
        averageThroughputMetric: "均速",
        firstTokenNotApplicable: "不适用",
        performanceNotRecorded: "未记录",
        nonStreamFirstTokenHint: "非流式请求一次性返回完整响应，未单独测量首字时间。",
        averageThroughputHint: "输出 token ÷ 请求总耗时，包含等待和重试；输出中已有的推理 token 不重复相加。这是端到端平均速度。",
        streamThroughputHint: "按流式生成窗口计算的输出速度。缺少首字记录时不估算。",
      ...
      apiErrors: {
        ...
        webTrainingExclusionFailed: "关闭 Grok Web 训练数据使用失败",
  ...
  en: {
    translation: {
      ...
      webAccountSettings: {
        ...
        excludeFromTraining: "Disable training data use",
        excludeFromTrainingTitle: "Disable \"Improve the Model\"?",
        excludeFromTrainingDescription: "Disable Grok's Improve the Model setting so this account's content is excluded from model improvement.",
        excludeFromTrainingDone: "Training data use disabled",
      },
      webAccountScripts: {
        ...
        excludeFromTrainingDescription: "Disable Grok's Improve the Model setting so the selected accounts' content is excluded from model improvement.",
        run: "Run tasks",
      ...
      audits: {
        ...
        averageThroughputMetric: "Avg TPS",
        firstTokenNotApplicable: "N/A",
        performanceNotRecorded: "Not recorded",
        nonStreamFirstTokenHint: "Non-streaming requests return the complete response at once; TTFT is not measured separately.",
        averageThroughputHint: "Output tokens divided by total request time, including waits and retries. Reasoning tokens already included in output are not added again. This is an end-to-end average.",
        streamThroughputHint: "Output speed over the streaming generation window. Not estimated when TTFT is missing.",
        tokensPerSecondUnit: "Token/s",
      ...
      apiErrors: {
        ...
        webTrainingExclusionFailed: "Failed to disable Grok Web training data use",
